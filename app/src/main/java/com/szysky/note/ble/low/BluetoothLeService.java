...
import static com.szysky.note.ble.util.ComputerUtils.byts2str;
 ...
 *
 * ClassDescription : 此服务类 用于对蓝牙BLE设备Gatt模式  进行连接的管理和数据的通讯.
 *
...
public class BluetoothLeService extends Service {
    ...
    private UUID UUID_descriptor = UUID.fromString("00002902-0000-1000-8000-00805f9b34fb");//描述uuid
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            Log.e(TAG, "onConnectionStateChange: status-"+status+"  newStatus:"+newState);
